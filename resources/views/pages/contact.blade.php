...
@section('content')
 ...
 <section class="wow fadeIn parallax"  data-stellar-background-ratio="0.5" style="background-image:url('{{asset('images/pink.jpg')}}');">
  ...
  <!-- start contact form -->
  <section id="contact" id="contatto" class="wow fadeIn no-padding bg-extra-dark-gray">
    <div class="container-fluid">
        <div class="row equalize sm-equalize-auto">
            <div class="col-md-6 cover-background sm-height-450px xs-height-350px wow fadeIn" style="background: url({{asset('images/clock.png')}})"></div>
  ...
  <section class="no-padding one-second-screen sm-height-400px wow fadeIn">
      <iframe class="width-100 height-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d750.2571457061822!2d16.307564588294017!3d41.22114758880035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13381a7e7a13264d%3A0x721aabd8b056df0b!2sMETAINFOR!5e0!3m2!1sit!2sin!4v1526611415519" ></iframe>
  </section>
  <!-- end map section -->
