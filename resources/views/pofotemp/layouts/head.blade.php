 <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-109661433-1"></script>
    <script>
     window.dataLayer = window.dataLayer || [];
     function gtag(){dataLayer.push(arguments);}
     gtag('js', new Date());
     gtag('config', 'UA-109661433-1');
    </script>
    <!-- rich data google -->
    <script type="application/ld+json">
            ...
            "logo": "https://thinkwebstudio.com/images/logogrigio.png",
            "contactPoint": [{
                "@type": "ContactPoint",
